 ...
 * Также есть модели для PathFinder (нахождение пути) {@link com.hestia.sixthsense.utils.PathFinder},
 *  имеют такие же названия, но без Response.
 * Для создания подходяшего графа для PathFinder, исопльзуется {@link com.hestia.sixthsense.utils.PathFinder.NetworkConverter}
 * </p>
 *
