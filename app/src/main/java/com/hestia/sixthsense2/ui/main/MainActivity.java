...
import com.hestia.sixthsense2.data.bluetooth.AppBluetoothHelper;
...
import static com.hestia.sixthsense2.data.bluetooth.AppBluetoothHelper.GPS_RESOLUTION_REQUEST;
import static com.hestia.sixthsense2.data.bluetooth.model.Permissions.PERMISSION_REQUEST_COARSE_BL;
import static com.hestia.sixthsense2.data.bluetooth.model.Permissions.PERMISSION_REQUEST_COARSE_LOCATION;
...
public class MainActivity extends BaseActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isFirstLaunch2 = sharedPreferences.getBoolean("isFirstLaunch2", true);
        isFirstLaunch3 = sharedPreferences.getBoolean("isFirstLaunch4", true);
        if(isFirstLaunch3 && !sharedPreferences.getBoolean("isFirstLaunch3", true)){
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putBoolean("isFirstLaunch4", false);
            editor.apply();
            restartApplication();
        }
        // Service button
...
//        _createForegroundService();
    ...
    private void OpenAboutUs() {
        Intent intent = new Intent(MainActivity.this, com.hestia.sixthsense2.ui.main.AboutUsActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivityForResult(intent, 0);
    }
    ...
    private static void restartApplication() {
        ...
        try {
            // Запуск нового процесса Java
            ProcessBuilder builder = new ProcessBuilder(javaPath, "-cp", classPath, className);
            builder.start();
        } catch (IOException e) {
            e.printStackTrace();
        }

        // Завершение работы текущего процесса
        System.exit(0);
    }
