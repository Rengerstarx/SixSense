...
import com.hestia.sixthsense2.ui.route.RouteActivity;
import com.hestia.sixthsense2.ui.routing.detail.RoutingDetailLocations;
import com.hestia.sixthsense2.ui.routing.detail.RoutingDetailNodes;
import com.hestia.sixthsense2.ui.routing.master.RoutingMaster;
...
public class RoutingActivity extends FragmentActivity implements RoutingMaster.OnFragmentInteractionListener, RoutingDetailLocations.OnLocationFragmentInteractionListener, RoutingDetailNodes.OnNodeFragmentInteractionListener, TextToSpeech.OnInitListener {
    ...
    private Boolean FZap = false;
    SharedPreferences sharedPreferences;

    private TextToSpeech textToSpeech;
    private com.hestia.sixthsense2.ui.routing.BeaconBroadcastListener mBeaconBroadcastListener;
    ...
    private com.hestia.sixthsense2.ui.routing.BeaconBroadcastListener.BroadcastCallback broadcastCallback = new com.hestia.sixthsense2.ui.routing.BeaconBroadcastListener.BroadcastCallback() {
        @Override
        ...
        public void onNewBroadcastBeacon(NodeResponse node) {
            if(node.getBroadcastText().length() > 0){
                ...
                /**Если крякнет broadcast то через Toast можно будет посмотреть баг*/
                //Toast.makeText(getApplicationContext(),node.getBroadcastText(), Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FZap = sharedPreferences.getBoolean("isFirstLaunch3", true);
...
// Set default fragment
        ...
        if(FZap){
            ...
            editor.putBoolean("isFirstLaunch3", false);
            editor.apply();
    ...
    public void onInit(int i) {
        if(mBeaconBroadcastListener != null)
            mBeaconBroadcastListener.Stop();
        mBeaconBroadcastListener = new com.hestia.sixthsense2.ui.routing.BeaconBroadcastListener(getApplicationContext(), broadcastCallback);
